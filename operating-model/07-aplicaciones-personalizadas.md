...
- **Herramientas:** búsqueda/lectura web, `knowledge/ezti/`, generación de hoja de costes, borradores de email como Markdown/EML en la cola interna (el agente no tiene ningún scope de Gmail con capacidad de envío ni de borradores).
- **Output final:** (1) shortlist rankeada de 8–15 copackers con MOQ/costes/certificaciones/contacto y estado; (2) dossier de **compliance alimentario**: etiquetado Reglamento (UE) 1169/2011, claims nutricionales y de salud Reglamento (CE) 1924/2006 (crítico: qué NO puedes decir de un gel con miel), registro sanitario RGSEAA y requisitos de venta online de alimentos — **cada punto con fuente primaria y flag "verificar con asesor/consultor alimentario"**; (2b) **módulo separado de facturación/fiscalidad** (TicketBAI en Gipuzkoa y obligaciones de facturación): pertenece a la operación comercial, no a la normativa de producto, y se entrega después con su propio flag de revisión fiscal; (3) modelo de coste unitario por escenario (copacker A/B/C × volumen) con rangos, no cifras inventadas; (4) borradores de email de contacto ES/EN por proveedor; (5) barrido de ayudas (SPRI, Diputación Foral de Gipuzkoa, líneas agroalimentarias) con plazos y requisitos.
