...
- ✅ B7 (skills + repo) completado 2026-07-09: `hermes skills list` confirma las 13 skills semilla instaladas (categoría "oficina", trust community) sobre 69 builtin; rama activa en la VM es `claude/agent-system-next-steps-63li8s` (correcta). **Pendiente único:** confirmar si `gh auth login` se completó — necesario para que Hermes tenga permiso de escritura real en el repo (issues, ESTADO.md, PRs), requisito de F0.C.
